...
import { apiFetchWritingTest, apiUpdateWritingTest } from '@/lib/api';
...
export default function EditWritingTestScreen() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      await apiUpdateWritingTest(Number(id), {
        title: title.trim(),
        description: description.trim(),
        examType,
        isPublished,
      });
      toast.success('Saved', 'Writing test updated');
      router.back();
    } catch (e: any) {
  ...
  return (
    <SafeAreaView edges={['top']} style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Edit Writing Test</Text>
        <View style={{ width: 22 }} />
      </View>
